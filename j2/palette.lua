...
local p_type = p_varilable
-- local p_type = p_variable
local p_parameter = p_variable
local p_number = hsl(153, 71, 73)
local p_constant = hsl(50, 100, 79)
local p_string = hsl(139, 60, 54)
local p_keyword = hsl(179, 100, 79)
local p_function = p_variable
local p_comment = hsl(243, 99, 77)
...
local base = {
	...
	["@type.builtin"] = { fg = p_keyword, bold = true },
