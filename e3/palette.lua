...
local fg_p_0 = hsl(189, 43, 52) -- Comments
local fg_p_1 = hsl(0, 46, 70) -- Functions and number
local fg_p_2 = hsl(133, 65, 7) -- String
local fg_p_3 = hsl(213, 50, 21) -- Keyword
local fg_p_4 = hsl(41, 46, 69) -- Type
local fg_a = hsl(145, 73, 100) -- you can just type them normally.
local bg_a = hsl(160, 34, 10)
...
local bgc = make_contrastor(27, "bg")
local fgc = make_contrastor(6, "fg")

local muter = make_contrastor(4, "fg")
local lauter = make_contrastor(33, "bg")
...
local base = {
	...
	["@text.uri"] = { fg = blue },
	["@punctuation"] = { fg = lfg },
	["@keyword"] = { fg = lauter(fg_p_3), bold = true },
	["@type"] = { fg = fg_p_4, bold = true },
	["@type.builtin"] = { fg = muter(fg_p_4).li(22) },
	["@operator"] = { fg = fg_p_4, bold = true },
	["@variable"] = { fg = lfg },
	["@variable.builtin"] = { bold = true },
	["@constant"] = { fg = yellow, bold = true },
	["@string.regexp"] = { link = "Regexp" },
	["@function.call"] = { fg = fg_p_1 },
