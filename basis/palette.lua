...
local fg_p_0 = hsl(0, 53, 76) -- Comments
local fg_p_1 = hsl(224, 57, 66) -- Functions and number
local fg_p_2 = hsl(126, 69, 25) -- String
local fg_p_3 = hsl(29, 58, 58) -- Keyword
local fg_a = hsl(185, 3, 68) -- you can just type them normally.
local bg_a = hsl(140, 12, 7)
