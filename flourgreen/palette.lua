...
local grune = hsl(133, 100, 59)
local fg_p_0 = grune -- Comments
local fg_p_1 = grune -- Functions and number
local fg_p_2 = grune -- String
local fg_p_3 = grune -- Keyword
local fg_p_4 = grune -- Type
local fg_a = grune -- you can just type them normally.
