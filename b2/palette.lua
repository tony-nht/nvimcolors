...
local p_function = hsl(91, 74, 61) -- increment or decrement integers, or

local p_comment = hsl(142, 18, 53) -- increment or decrement integers, or
local lush_fg = hsl(151, 99, 86) -- you can just type them normally.
local lush_bg = hsl(12, 80, 0)
local p_string = hsl(114, 62, 59)
local p_variable = hsl(74, 16, 93)
local p_keyword = hsl(197, 86, 58)

local lfg = p_variable
local lbg = lush_bg
local background = lush_bg

local p_operator = hsl(185, 87, 66)
local p_type = hsl(154, 116, 62)
local p_parameter = hsl(310, 52, 70)
local p_number = hsl(13, 85, 70)
...
local base = {
	...
	["@function.call"] = { fg = p_keyword, bold = true },
