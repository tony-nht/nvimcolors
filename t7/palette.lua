...
local p_type = hsl(0, 100, 72)
-- local p_parameter = hsl(211, 100, 87)
local p_parameter = p_main_fg
local p_number = hsl(135, 100, 80)
local p_constant = hsl(68, 100, 63)
local p_string = hsl(198, 90, 64)
local p_keyword = hsl(242, 66, 77)
local p_function = p_main_fg
local p_comment = hsl(148, 100, 53)
