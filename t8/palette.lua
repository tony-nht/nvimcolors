...
local p_type = hsl(329, 100, 72)
-- local p_parameter = hsl(211, 100, 87)
local p_parameter = p_main_fg
local p_number = hsl(135, 100, 80)
local p_constant = hsl(0, 100, 64)
local p_string = hsl(27, 100, 68)
local p_keyword = hsl(227, 50, 71)
