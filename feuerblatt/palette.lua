...
local water_deep = hsl(224, 57, 66) -- increment or decrement integers, or
local lush_fg = hsl(185, 3, 68) -- you can just type them normally.
local lush_bg = hsl(140, 12, 7)

local blatt = hsl(149, 100, 42)
local feuer = hsl(29, 58, 58)
local lfg = lush_fg
local lbg = lush_bg
...
local base = {
	...
	MiniStatuslineModeNormal = { fg = white, bg = blatt.da(51) },
	MiniStatuslineModeCommand = { fg = white, bg = feuer.da(51) },
	-- Rust
	...
	TelescopeSelection = { bg = blatt.da(70), bold = true },
...
local theme = lush(function()
	return {
		...
		Keyword({ fg = feuer }),
		Number = { fg = water_deep },
		String({ fg = blatt.sa(49).da(25) }),
