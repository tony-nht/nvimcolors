...
local water = hsl(173, 53, 76) -- Vim has a mapping, <n>C-a and <n>C-x to
local p_function = hsl(197, 90, 47) -- increment or decrement integers, or

local p_comment = hsl(142, 100, 40) -- increment or decrement integers, or
local lush_fg = hsl(151, 99, 86) -- you can just type them normally.
local lush_bg = hsl(145, 100, 0)

local p_string = hsl(57, 86, 66)
local p_keyword = hsl(182, 93, 58)
local lfg = lush_fg
local lbg = lush_bg
local background = lush_bg

local p_operator = hsl(185, 92, 73)
local p_type = hsl(142, 82, 70)
local p_number = hsl(142, 82, 70)
