...
local mc = hsl(24, 29, 54)
local fg_p_0 = mc -- Comments
local fg_p_1 = mc -- Functions and number
local fg_p_2 = mc -- String
local fg_p_3 = mc -- Keyword
local fg_p_4 = mc -- Type
local fg_a = mc -- you can just type them normally.
