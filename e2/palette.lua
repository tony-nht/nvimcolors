...
local fg_p_1 = hsl(160, 42, 55) -- Functions and number
local fg_p_2 = hsl(115, 24, 10) -- String
local fg_p_3 = hsl(75, 29, 26) -- Keyword
local fg_a = hsl(185, 6, 60) -- you can just type them normally.
local bg_a = hsl(140, 12, 13)
...
local base = {
	...
	TelescopeSelection = { fg = lauter(bg_a), bg = bgc(fg_p_2), bold = true },
