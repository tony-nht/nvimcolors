...
local ocean = hsl(229, 100, 37)
local fg_p_0 = ocean -- Comments
local fg_p_1 = ocean -- Functions and number
local fg_p_2 = ocean -- String
local fg_p_3 = ocean -- Keyword
local fg_p_4 = ocean -- Type
local fg_a = ocean -- you can just type them normally.
local bg_a = hsl(54, 99, 92)
...
local muter = make_contrastor(2, "fg")
local lauter = make_contrastor(4, "bg")
