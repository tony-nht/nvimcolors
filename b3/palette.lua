...
local p_parameter = hsl(101, 50, 58)
local p_number = hsl(371, 55, 61)
-- local p_number = hsl(238, 39, 70)  @ALT1
local p_constant = hsl(146, 61, 55)
local p_string = hsl(64, 75, 49)
local p_keyword = hsl(188, 69, 67)
local p_function = hsl(180, 98, 35) -- increment or decrement integers, or
local p_comment = hsl(243, 99, 77) -- increment or decrement integers, or
