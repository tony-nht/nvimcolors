...
local orangen = hsl(23, 95, 63)
local fg_p_0 = orangen -- Comments
local fg_p_1 = orangen -- Functions and number
local fg_p_2 = orangen -- String
local fg_p_3 = orangen -- Keyword
local fg_p_4 = orangen -- Type
local fg_a = orangen -- you can just type them normally.
local bg_a = hsl(180, 100, 0)
...
local muter = make_contrastor(22, "fg")
local lauter = make_contrastor(40, "bg")
