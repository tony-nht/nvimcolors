...
local p_type = hsl(0, 97, 75)
-- local p_parameter = hsl(211, 100, 87)
local p_parameter = p_main_fg
local p_number = hsl(153, 71, 78)
local p_constant = hsl(31, 76, 58)
local p_string = hsl(205, 88, 73)
-- local p_string = hsl(200, 100, 53)
local p_keyword = hsl(215, 85, 99)
local p_function = p_main_fg
local p_comment = hsl(108, 94, 62)
